...
export  function ModalEstadoCancelar({texto,id}) {
    ...
    <div>
        ...
        <div className='confirmacion'>
           ...
           <div className='botones'>
            <Button  variant="contained"  onClick={()=>cancelarCompra(id)} sx={{width:"fit-content"}} >SI</Button>
            <Button variant="contained" onClick={cancelar} sx={{width:"fit-content"}}>NO</Button>
            </div>
        </div>
        </div>
